...
export default function SummarySection({ issues, title = "Key Metrics" }: SummarySectionProps) {
  ...
  const cards = [
    ...
    { key: "risk", label: "Risks / Warnings", value: countRisk, desc: "Potential problems", color: "amber" },
    { key: "availability", label: "Availability", value: countAvailability, desc: "Status updates", color: "sky" },
